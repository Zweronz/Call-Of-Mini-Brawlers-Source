...
public class ZombieBiteFightBehavior : IFightBehavior
{
	...
	public ZombieBiteFightBehavior(int zombieId, GameObject target, float coefficientOfDamage)
	{
	...
	public void Execute()
	{
		if (null != target)
		{
			target.OnBiteHurt(zombieId, CalculateHurt(zombieId, target));
		}
	}
