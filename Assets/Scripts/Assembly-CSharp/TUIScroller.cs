...
public class TUIScroller : TUIControlImpl
{
	...
	public void Start()
	{
		...
		{
			position.x = scrollObject.transform.localPosition.x;
			position.y = scrollObject.transform.localPosition.y;
		}
	}
	...
	protected void ScrollObjectBegin()
	{
		...
		{
			TUIControl component = scrollObject.GetComponent<TUIControl>();
			if ((bool)component)
			{
				component.ResetChild();
			}
		}
	}
